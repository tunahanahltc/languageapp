...
const categoryIcons = {
  ...
  practice: { name: "target", type: "MaterialIcons" },
}
...
export default function PracticeScreen({ navigation }) {
  ...
  const [selectedWordSet, setSelectedWordSet] = useState("all")
  ...
  const handleStartPractice = (activity) => {
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
                ...
                {Object.entries(wordSetLabels).map(([value, label]) => (
                  ...
                  >
                    {selectedWordSet === value && selectedActivity ? (
                      <LinearGradient colors={selectedActivity.colors} style={styles.selectedOption}>
              ...
              <TouchableOpacity onPress={startPracticeWithWordSet} style={styles.startPracticeButton}>
                {selectedActivity && (
                  <LinearGradient colors={selectedActivity.colors} style={styles.startPracticeGradient}>
